...
public class SideBarView extends RelativeLayout implements View.OnClickListener{
    ...
    public interface EventListener {
        ...
        public SideBarView(Context context) { this(context, null); init(); }
        ...
        switch (view.getId()){
        case R.id.btn_cancel : listener.btnCancel();
         break;
         case R.id.btn_side_level_1 : listener.btnLevel1(); break; default: break;
         } } }
